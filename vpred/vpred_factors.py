...
def find_factors(factors_in, _S, rXY: NDArray, match_ind: Optional[Union[float,NDArray]] = None, 
    ...
    _factors_in, _factors_out = getFactors(_factors_in, _factors_out, ["lgrad", "lcoef"],                                           find_linear_factors,            S=seq, rXY=rXY, mXY=rXY[match_ind, :], cutoff=cutoff,       _all=_all)
